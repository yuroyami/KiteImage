<#--
  ...
  https://yuroyami.github.io/KiteImage/ and https://github.com/yuroyami/KiteImage are substituted per repository by
...
<#macro display>
    <header class="navigation theme-dark" id="navigation-wrapper" role="banner">
        ...
        <nav class="kite-nav-links" aria-label="Kite documentation">
            <a href="https://yuroyami.github.io/KiteImage/">Guide</a>
            <a href="https://github.com/yuroyami/KiteImage">GitHub</a>
        </nav>
